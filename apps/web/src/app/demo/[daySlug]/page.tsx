...
import { queryDemoCalendarDayData,  queryDemoCalendarDayPaths } from "@/lib/sanity/query";
import { getSEOMetadata } from "@/lib/seo";
import { Snowflakes } from "@/components/Snowflakes";
import { DayHeader } from "../../[daySlug]/components/DayHeader";
import BreakDayContent from "@/components/BreakDayContent";
import { DayLesson } from "../../[daySlug]/components/DayLesson";
...
async function fetchCalendarDayData(slug: string, stega = true) {
  return await sanityFetch({
    query: queryDemoCalendarDayData,
    params: { slug },
    stega
  });
}
...
async function fetchCalendarDayPaths() {
  try {
    const slugs = await client.fetch(queryDemoCalendarDayPaths);
