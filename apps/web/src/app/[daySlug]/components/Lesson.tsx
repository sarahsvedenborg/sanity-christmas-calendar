            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="demo-studio" className="border-amber-300/50 dark:border-amber-700/50">
                ...
                <AccordionContent className="pt-4 text-base text-green-900 dark:text-white/70">
                  <p className="mb-4">
                    Hvis du trenger/ønsker tilgang til et demo studio, kan du finne <Link href="/demo-docs" className="inline-flex items-center gap-2 font-semibold text-green-900 underline transition-colors hover:text-green-700 dark:text-blue-400 dark:hover:text-blue-200">informasjon om dette i demo-dokumentasjonen.</Link>
                  </p>
                {/*   <Link
                    href="/demo-docs"
